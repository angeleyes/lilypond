...
Constrained_breaking::initialize ()
{
  ...
  Real space = 0;
  Real padding = 0;
  Page_layout_problem::read_spacing_spec (spacing_spec, &space, ly_symbol2scm ("space"));
  Page_layout_problem::read_spacing_spec (spacing_spec, &padding, ly_symbol2scm ("padding"));
  Page_layout_problem::read_spacing_spec (page_breaking_spacing_spec, &space, ly_symbol2scm ("space"));
